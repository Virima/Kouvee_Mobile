...
public class Search_Filter_Detail_Pengadaan extends Filter {
    Adapter_Detail_Pengadaan adapter;
    ArrayList<Pengadaan_Model> filterList;

    public Search_Filter_Detail_Pengadaan(ArrayList<Pengadaan_Model> filterList, Adapter_Detail_Pengadaan adapter)
    {
