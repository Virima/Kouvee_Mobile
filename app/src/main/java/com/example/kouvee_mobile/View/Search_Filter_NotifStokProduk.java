...
public class Search_Filter_NotifStokProduk extends Filter {
    Adapter_NotifStokProduk adapter;
    ArrayList<Produk_Model> filterList;

    public Search_Filter_NotifStokProduk(ArrayList<Produk_Model> filterList, Adapter_NotifStokProduk adapter)
    {
