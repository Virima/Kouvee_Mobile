...
public class SearchCust_Filter_Produk extends Filter {
    AdapterCust_Produk adapter;
    ArrayList<Produk_Model> filterList;

    public SearchCust_Filter_Produk(ArrayList<Produk_Model> filterList, AdapterCust_Produk adapter)
    {
